    ...
    public function print_order_convert($checkout_code){
        ...
        <div style="float: left; margin: 0 0 1.5em 0; ">
         <strong style="font-size: 18px;">PhongVu</strong>
          <br />
          <strong>Địa chỉ:</strong> 92 Nguyễn Khánh Toàn, Hà Nội.
          <br/>
          <strong>Điện thoại:</strong> 0964688431   
          <br/>
          <strong>Website:</strong> Laptopshop.demo
          <br/>
          <strong>Email:</strong> shoplaptop@gmail.com
        </div>
        ...
        <hr style="border: none; border-top: 2px solid #0975BD;"/>
          <div style="margin: 0 0 1em 0; padding: 1em; border: 1px solid #d9d9d9;">
            ...
            <br>
            <strong>Phương thức vận chuyển</strong><br> Ship
          </div>
        ...
        </td></tr></table><br/><br/><br/><p>Nếu bạn có thắc mắc, vui lòng liên hệ chúng tôi qua email <u>shoplaptop@gmail.com</u> hoặc 0773654031</p></div>
        ';
